...
## Remote Setup
The live application is hosted on [https://glacial-ridge-22649.herokuapp.com](https://glacial-ridge-22649.herokuapp.com/)
...
The tokens can be found in the Postman collection, or can be generated by logging in again through the login URL with the credentials above: https://nooreldeensalah2.us.auth0.com/authorize?audience=CastingAgencyAPI&response_type=token&client_id=ZIDquiYmfjIcn7lCDBCznBoQQ0rlQpLi&redirect_uri=http://localhost:8100
# API Documentation
